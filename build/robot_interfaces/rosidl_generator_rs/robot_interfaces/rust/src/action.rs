...
#[link(name = "robot_interfaces__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_action_type_support_handle__robot_interfaces__action__RobotTask() -> *const std::ffi::c_void;
}

// Corresponds to robot_interfaces__action__RobotTask
#[allow(missing_docs, non_camel_case_types)]
...
impl rosidl_runtime_rs::Action for RobotTask {
  ...
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_action_type_support_handle__robot_interfaces__action__RobotTask() }
  }
